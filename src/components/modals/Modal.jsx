/**
 * components/modals/Modal.jsx — shell that routes to form components
 */
...
const ICON_MAP = { topic: BookOpen, job: Zap, flow: GitBranch, project: FolderOpen, event: Radio };
const TITLE_MAP = (editing) => ({
...
const COLOR_MAP = { topic: '#6366f1', job: '#f59e0b', flow: '#10b981', project: '#8b5cf6', event: '#ec4899' };
        ...
        <AnimatePresence>
            {modalOpen && (
                ...
                >
                    ...
                    >
                        <div className="modal-header" style={{ '--modal-color': color }}>
